...
$pdf->Cell(17.5,0.7,"Laporan Data Tipe Transportasi",0,10,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
...
$pdf->Cell(4.5, 0.8, 'Kode Tipe', 1, 0, 'C');
$pdf->Cell(7.5, 0.8, 'Deskripsi', 1, 1, 'C');
$pdf->SetFont('Arial','',10);
$no=1;
$query=mysql_query("select * from transportation_type");
while($r=mysql_fetch_array($query)){
	$pdf->Cell(1.5, 0.8, $no , 1, 0, 'C');
	$pdf->Cell(4.5, 0.8, $r[0],1, 0, 'C');
	$pdf->Cell(7.5, 0.8, $r[1], 1, 1,'C');

	$no++;
}

$pdf->Output("lap_tt.pdf","I");

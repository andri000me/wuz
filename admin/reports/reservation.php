...
$pdf->Cell(26.5,0.7,"REKAP DATA RESERVATION",0,10,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
...
$pdf->Cell(3, 0.8, 'Keberangkatan', 1, 0, 'C');
$pdf->Cell(3, 0.8, 'Kode Customer', 1, 0, 'C');
$pdf->Cell(3, 0.8, 'Kode Rute', 1, 0, 'C');
$pdf->Cell(3, 0.8, 'Jumlah Tiket', 1, 0, 'C');
$pdf->Cell(3, 0.8, 'Total Harga', 1, 0, 'C');
$pdf->Cell(3, 0.8, 'Pembayaran', 1, 0, 'C');
$pdf->Cell(4, 0.8, 'Kode Pembayaran', 1, 1, 'C');
...
while($lihat=mysql_fetch_array($query)){
	...
	$pdf->Cell(3, 0.8, $lihat[1], 1, 0,'C');
	$pdf->Cell(3, 0.8, $lihat[2],1, 0, 'C'); 
	$pdf->Cell(3, 0.8, $lihat[3], 1, 0,'C'); 
	$pdf->Cell(3, 0.8, $lihat[4], 1, 0,'C');
	$pdf->Cell(3, 0.8, $lihat[5], 1, 0,'C');
	$pdf->Cell(3, 0.8, $lihat[6], 1, 0,'C');
	$pdf->Cell(4, 0.8, $lihat[7], 1, 1,'C');

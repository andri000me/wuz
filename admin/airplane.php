                          ...
                          <div class="modal-dialog">
                            <div class="modal-content goleft" style="z-index:9999">
                              ...
                              <div class="modal-body">
                                ...
                                <br>
                                <p>Nama 
                                <p><input name="nm" type="text" class="form-control" placeholder="Nama Pesawat" required>
                                <p>Jumlah Kursi
                                ...
                                <select name="kd_tt" class="form-control" required>
                                    <option value="EP">Economi</option>
                                    <option value="BP">Bussiness</option>
                                </select>
                                <p>Deskripsi
                                <p>
        ...
        <?php } ?>
            ...
            <div class="pnn ml" style="padding:20px">
                <table class="table">
                    ...
                    <tbody id="data">
                        <?php
                            foreach($trans->selectAllLimit('P',$start,$sum) as $r){
                                $no++;
                        ?>
                        <tr>
                            <td><?=$no?></td>
            ...
            <?php } ?>
                ...
                <table class="table" style="width:90%;margin:0 0px 20px 30px">
                        <thead>
                            <th colspan="2">Detail Pesawat</th>
                        </thead>
                        <tbody>
                           <!--  <tr>
                            ...
                            <tr>
                                <td style="width:15%">Kode Pesawat</td>
                                <td>:</td>
                                <td><?=$r[0]?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Jenis Pesawat</td>
                                <td>:</td>
                                <td><?=(($r[3] == 'EP' ? 'Economi' : 'Bussiness'))?></td>
                            </tr>
                            <tr>
                                <td>Description</td>
                                <td>:</td>
                            ...
                            <tr>
                                ...
                                <td class="td-pad">
                                    <select class="form-control" name="kd_tt">
                                        <option value="EP" <?=(($r[3] == 'EP' ? 'selected' : ''))?>>Economi</option>
                                        <option value="BP" <?=(($r[3] == 'BP' ? 'selected' : ''))?>>Bussiness</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
